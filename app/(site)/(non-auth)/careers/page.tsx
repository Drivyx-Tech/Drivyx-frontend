        ...
        <SectionContainer my={{ base: 6, lg: 10 }}>
          ...
          >
            ...
            <Text textStyle={"context"}>
              Are you passionate about sustainability and making a positive
              impact in your community? Drivyx is on the lookout for dedicated
              individuals to join us as Local On-the-Ground Ambassadors. As an
              Ambassador, you will play a crucial role in identifying and
              onboarding ESG (Environmental, Social, Governance) projects that
              are making a difference and seeking funding onto the Drivyx
              platform.
            </Text>
          </Stack>
          ...
          >
            ...
            <Text textStyle={"smContext"}>
              ...
              >
                ...
                sustainability by identifying and promoting impactful ESG
            ...
            <Text textStyle={"smContext"}>
              <Highlight
                ...
                styles={{ fontWeight: "bold", color: "secondary.800" }}
              >
                Be a Changemaker: Play a pivotal role in connecting
                environmentally conscious investors with projects aligned with
                their values.
              </Highlight>
            </Text>
            <Text textStyle={"smContext"}>
              <Highlight
                ...
                styles={{ fontWeight: "bold", color: "secondary.800" }}
              >
                Expand Your Network: Join a community of like-minded individuals
                and organizations dedicated to creating a greener, more
                sustainable future.
              </Highlight>
            </Text>
            <Text textStyle={"smContext"}>
              <Highlight
                ...
                styles={{ fontWeight: "bold", color: "secondary.800" }}
              >
                Flexible Opportunities: As a Local On-the-Ground Ambassador,
                you'll have the flexibility to work at your own pace while
                actively contributing to the growth of Drivyx.
              </Highlight>
            </Text>
          </Stack>
          ...
          >
            ...
            <Text textStyle={"smContext"}>
              <Highlight
                ...
                styles={{ fontWeight: "bold", color: "secondary.800" }}
              >
                Onboard Projects: Guide and assist project owners in the process
                of creating and showcasing their initiatives on Drivyx, ensuring
            ...
            <Text textStyle={"smContext"}>
              <Highlight
                ...
                styles={{ fontWeight: "bold", color: "secondary.800" }}
              >
                Community Outreach: Act as a liaison between Drivyx and the
                local sustainability community, participating in events and
                initiatives to raise awareness about our platform.
              </Highlight>
            </Text>
            <Text textStyle={"smContext"}>
              <Highlight
