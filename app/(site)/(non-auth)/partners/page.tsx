      ...
      <SectionContainer my={{ base: 10, lg: 16 }}>
        ...
        >
          ...
          <Text textStyle={"context"}>
            At Drivyx, we are actively seeking like-minded investment partners
            who share our commitment to Environmental, Social, and Governance
            (ESG) principles. Our mission is to drive positive change by
            supporting projects that prioritize sustainability, social
            responsibility, and ethical governance. If you are an investment
            partner looking to make a meaningful impact, we invite you to
