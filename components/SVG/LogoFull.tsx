...
const LogoFull = () => (
  <svg width={"230px"} height={"230px"} viewBox="60 400 1024 1024">
    ...
    <text
      ...
      transform="translate(604.307 482.302) scale(2.575)"
    >
      <tspan x={-63.675} y={12.895}>
        {"Drivyx"}
      </tspan>
    </text>
    <text
      ...
      transform="translate(430.012 563.033) scale(2.575)"
    >
      <tspan x={-128.16} y={7.282}>
        {"gear up for global green"}
      </tspan>
    </text>
    <linearGradient
      id="a"
    ...
    <path
      ...
      transform="matrix(1.73237 0 0 1.73237 784.89 436.495)"
    />
  </svg>
);
